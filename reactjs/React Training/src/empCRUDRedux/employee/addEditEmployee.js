...
import { createEmployee, getEmployee, updateEmployee } from "../api/employee.api";
import { useDispatch } from "react-redux";
import { addEmployee, editEmployee } from "../action/employee.action";
...
export default function AddEditEmployee() {
    ...
    async function onSubmit({ id, name, designation }) {
        if (empid) {
                ...
                dispatch(editEmployee(empid,name,designation))
                Swal.fire({
                    title: "Updated",
